...
-- Auto-generated by build/transform.sh from devel/sql/pgque.sql. Do not edit by hand.
...
-- passing the contents of devel/sql/pgque.sql as the extension body.
--
-- Prerequisites:
...
--
-- Usage:
--   psql -d mydb -f devel/sql/pgque-tle.sql
--   psql -d mydb -c 'create extension pgque;'
--
-- Uninstall:
--   psql -d mydb -f devel/sql/pgque-tle-uninstall.sql
